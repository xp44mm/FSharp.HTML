...
let rules = [|["children";"nodes"],"List.rev s0";["children"],"[]";["nodes";"nodes";";";"node"],"s2::s0";["nodes";"node"],"[s0]";["node";"TEXT"],"HtmlText s0";["node";"COMMENT"],"HtmlComment s0";["node";"CDATA"],"HtmlCData s0";["node";"element"],"s0";["element";"TAGSELFCLOSING"],"let name,attrs = s0\r\nHtmlElement(name, attrs,[])";["element";"TAGSTART";"children";"TAGEND"],"let name,attrs = s0\r\nlet el = HtmlFsyaccUtils.htmlNode name s2\r\nel attrs s1"|]
...
let declarations = [|"TAGSTART","string*HtmlAttribute list";"TAGEND","string";"TAGSELFCLOSING","string*HtmlAttribute list";"CDATA","string";"COMMENT","string";"TEXT","string";"node","HtmlNode";"element","HtmlNode";"children","HtmlNode list";"nodes","HtmlNode list"|]
open System
open FSharp.HTML
open FSharp.HTML.HtmlTokenUtils
