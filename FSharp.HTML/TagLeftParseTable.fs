...
//            let result: string * string = s0, s1
//            box result
//        [ "attributes" ],
//        fun (ss: obj list) ->
...
//            let result: list<string * string> = s1 :: s0
//            box result
//        [ "closeAngle"; "DIV_RANGLE" ],
//        fun (ss: obj list) ->
//            let s0 = unbox<int> ss.[0]
//            let result: int * string = s0, "/>"
//            box result
//        [ "closeAngle"; "RANGLE" ],
//        fun (ss: obj list) ->
//            let s0 = unbox<int> ss.[0]
...
//            box result
//    ]
//let unboxRoot = unbox<PositionWith<HtmlToken>>
