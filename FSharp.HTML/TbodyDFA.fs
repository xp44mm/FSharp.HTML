...
let nextStates = [|0u,[|"</caption>",1u;"</colgroup>",1u;"<caption/>",1u;"<colgroup/>",1u;"<table>",1u;"<tr/>",4u;"<tr>",4u;"CDATA",4u;"COMMENT",4u;"DOCTYPE",4u;"EOF",4u;"TAGEND",4u;"TAGSELFCLOSING",4u;"TAGSTART",4u;"TEXT",4u|];1u,[|"<tr/>",3u;"<tr>",3u;"COMMENT",2u|];2u,[|"<tr/>",3u;"<tr>",3u;"COMMENT",2u|]|]
