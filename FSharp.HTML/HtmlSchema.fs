...
let allTagNames = htmlTags + mathmlTags + svgTags
...
let rawTextElements = set [ "script"; "style" ]

let escapableRawTextElements = set [ "textarea"; "title" ]
